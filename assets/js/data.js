...
(function (global) {
    ...
    /* type:    invitation | bid | interpretation
       status:  new | bid_requested | bid_submitted | accepted | declined | expired */
    var INVITATIONS = [
        {
            jobId: 48210,
            type: "invitation",
        ...
        },
        {
            ...
            docFormat: "PDF",
            pm: PM.daniel,
            declineReason: "Not available in that window",
        ...
        },
        {
            ...
            docFormat: "DOCX",
            pm: PM.sara,
            declineReason: "Rate below my minimum for legal review",
        ...
        },
        {
            ...
            docFormat: "DOCX",
            pm: PM.daniel,
            declineReason: "Outside my specialty",
    ...
    RP.STATUS = {
        new: { label: "Invited", pill: "status-new" },
        bid_requested: { label: "Bid requested", pill: "status-paid" },
        bid_submitted: { label: "Bid submitted", pill: "status-edited" },
        accepted: { label: "Accepted", pill: "status-inProgress" },
        declined: { label: "Declined", pill: "status-declined" },
        expired: { label: "Expired", pill: "status-draft" }
    };
